...
<div id="wrapper"> <!--Div Wrapper START-->
		...
		<div id="left" style="background: rgba(0, 0, 0, 0.5); padding-left:10px;" >
					...
					<p style="color:#ffffff; font-weight:bold; font-family: cursive; font-size:16px">
						  Information for foreign students in Karlsruhe.
					</p>
					<br>
					</div>
...
<script src="http://www.openlayers.org/api/OpenLayers.js"></script>
  <script>
    ...
    var lonLat = new OpenLayers.LonLat( 8.403653 ,49.006890 ).transform(epsg4326, projectTo);
...
var feature = new OpenLayers.Feature.Vector(
            new OpenLayers.Geometry.Point( 8.40166597537923 ,49.01003030000012 ).transform(epsg4326, projectTo),
