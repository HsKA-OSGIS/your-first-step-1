...
<style>
  ...
  <div id="wrapper"> <!--Div Wrapper START-->
	...
	<div id="left" style="background: rgba(0, 0, 0, 0.5); padding-left:10px;" >
					<div>
					<img src="../img/crv.jpg" style="width:250px;height:120px">
					<p style="color:#ffffff; font-weight:bold; font-family: cursive; font-size:24px">
						  City Registration & Vias
					</p>
...
<br>
						<h1 style="color:#ffffff; font-family: cursive; font-weight:bold; font-size:16px">
						  ...
						  For registering, you will need your passport/ID card and a copy of your rental contract.
						  <br>
						  For visa extension Health Insurance and Financial Support documents is also required. 
						  </p>
					</div>
					
<br>
					
 			<form action="insert_crv.php" method="POST">
					<table>
                  <tr> 
              <td><b>Comments:</b></td>
            </tr>
...
?> </td>
  ...
  var iconFeature1 = new ol.Feature({
	geometry : new ol.geom.Point(ol.proj.transform([8.373895400000038 ,49.0109082000001], 'EPSG:4326', 'EPSG:3857'))
  });
 ...
 var iconFeature2 = new ol.Feature({
	geometry : new ol.geom.Point(ol.proj.transform([8.40324575770885 , 49.00862575], 'EPSG:4326', 'EPSG:3857'))
  });
