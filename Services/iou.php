...
<style>
  ...
  <div id="wrapper"> <!--Div Wrapper START-->
	...
	<div id="left" style="background: rgba(0, 0, 0, 0.5); padding-left:10px;" >
					<div>
					<img src="../img/iou.jpg" style="width:250px;height:120px">
...
<br>
						<h1 style="color:#ffffff; font-family: cursive; font-weight:bold; font-size:16px">
						  ...
						  You will find lots of info in your universities international office. 
						  </p>
					</div>				
					
<br>
					
			<form action="insert_iou.php" method="POST">
					<table>
                  <tr> 
              <td><b>Comments:</b></td>
            </tr>
...
//International 1  
  var iconFeature1 = new ol.Feature({
	geometry : new ol.geom.Point(ol.proj.transform([8.418751356997074 , 49.010312450000264], 'EPSG:4326', 'EPSG:3857'))
  });
 ...
 var iconFeature2 = new ol.Feature({
	geometry : new ol.geom.Point(ol.proj.transform([8.390818527911309 , 49.0163725000002], 'EPSG:4326', 'EPSG:3857'))
  });
