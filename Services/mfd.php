...
<style>
  ...
  <div id="wrapper"> <!--Div Wrapper START-->
	...
	<div id="left" style="background: rgba(0, 0, 0, 0.5); padding-left:10px;" >
					<div>
					<img src="../img/mfd.jpg" style="width:250px;height:120px">
...
<br>
						<h1 style="color:#1A3F09; font-family: cursive; font-weight:bold; font-size:16px">
						  ...
						  There are KIT and HSKA mensa are available for student to have good and cheap food for the student. 
						  KIT Mensa is open two times in a day.
						  </p>
					</div>			
					
<br>
					
			<form action="insert_mfd.php" method="POST">
					<table>
                  <tr> 
              <td><b>Comments:</b></td>
            </tr>
...
//MDF 1  
  var iconFeature1 = new ol.Feature({
	geometry : new ol.geom.Point(ol.proj.transform([8.394084138980228 , 49.014846399999975], 'EPSG:4326', 'EPSG:3857'))
  });
 ...
 //MDF 3  
  var iconFeature3 = new ol.Feature({
	geometry : new ol.geom.Point(ol.proj.transform([8.416467999999984 , 49.0110000009994], 'EPSG:4326', 'EPSG:3857'))
  });
 ...
 map.addLayer(vectorLayer3);
  ...
  var iconFeature4 = new ol.Feature({
	geometry : new ol.geom.Point(ol.proj.transform([8.4106442 , 48.9996277000001], 'EPSG:4326', 'EPSG:3857'))
  });
 ...
 //mdf 5  
  var iconFeature5 = new ol.Feature({
	geometry : new ol.geom.Point(ol.proj.transform([8.396882200000123 , 49.01051759999982], 'EPSG:4326', 'EPSG:3857'))
  });
 ...
 //mdf 6  
  var iconFeature6 = new ol.Feature({
	geometry : new ol.geom.Point(ol.proj.transform([8.404602099999984 , 49.009706900000296], 'EPSG:4326', 'EPSG:3857'))
  });
 ...
 //mdf 7  
  var iconFeature7 = new ol.Feature({
	geometry : new ol.geom.Point(ol.proj.transform([8.402446300000063 , 49.00864730000012], 'EPSG:4326', 'EPSG:3857'))
  });
 ...
 //mdf 8 
  var iconFeature8 = new ol.Feature({
	geometry : new ol.geom.Point(ol.proj.transform([8.416062700000095 , 49.00884089999975], 'EPSG:4326', 'EPSG:3857'))
  });
